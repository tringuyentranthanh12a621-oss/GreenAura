...
bằng ảnh thật (PNG/JPG), giữ nguyên tên file:
  ...
  assets/prize-keychain.jpg      -> Móc khóa          (đã thay)
  assets/prize-fan.jpg           -> Quạt cầm tay      (đã thay)
  assets/prize-voucher.jpg       -> Voucher           (đã thay)
  assets/prize-bear.jpg          -> Gấu bông          (đã thay)
